...
> Built silent on purpose: not signed in to HeyGen, and the local voice/music
> engines need multi-GB installs. The user records their own voiceover from
> `demo/SCRIPT.md`, so on-screen text carries the message in this cut.
